...
export default function AdminAssignmentPreview() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto space-y-6 pb-10">
        ...
        <div className="flex items-start justify-between gap-4 flex-wrap">
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400 mt-1">Assignment details and management</p>
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.97 }}
              onClick={() => {
                if (window.confirm("Are you sure you want to delete this assignment? This action cannot be undone and will delete all submissions and grades.")) {
                  deleteAssignment();
                }
              }}
              disabled={isDeleting}
      ...
      <Fade delay={0.1}>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {[
            ...
            { icon: CheckCircle2, label: "Graded", value: stats?.graded || 0, color: "text-emerald-600", bg: "bg-emerald-50 dark:bg-emerald-950/40" },
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-gray-600">Max Score: {assignment.maxScore}</span>
                <span className="text-xs px-2 py-1 rounded-full bg-gray-100 dark:bg-white/[0.05] text-gray-600">
      ...
      {/* Submissions */}
      <SectionCard icon={Users} title="Submissions" delay={0.2}>
                    ...
                    <div className="flex items-center gap-2">
                      {submission.grade ? (
                        <span className="text-sm font-bold text-emerald-600">
                          {submission.grade.resolvedGrade}/{assignment.maxScore}
                        </span>
                      ) : (
