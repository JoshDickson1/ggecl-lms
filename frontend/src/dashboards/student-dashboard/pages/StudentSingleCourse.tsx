        ...
        <div className="flex flex-col gap-3">
          <motion.button
            ...
            className="w-full flex items-center justify-center gap-2.5 py-3.5 rounded-2xl
              ...
              shadow-[0_6px_24px_rgba(59,130,246,0.45)] transition-colors duration-200 disabled:opacity-70"
          >
          ...
          <div className="flex gap-2">
            <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.96 }}
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl text-sm font-semibold
                border transition-all duration-200 disabled:opacity-70 ${
                wishlisted
...
export default function StudentSingleCourse() {
  ...
  if (isError || !course) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center gap-4">
        ...
        <Link to="/student/explore" className="text-blue-500 hover:underline text-sm">
          Back to courses
        </Link>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-gray-50/60 dark:bg-[#080d18]">
      ...
      {/* ── Hero ──────────────────────────────────────────────────────────── */}
      <div ref={heroRef} className="relative rounded-2xl overflow-hidden">
        ...
        <motion.div style={{ opacity: heroOpacity }}
          className="relative z-10 max-w-[1380px] mx-auto px-6 pt-6 pb-16">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-8">
            ...
            {course.syllabus?.length > 0 && (
              <motion.section initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
                className="rounded-[24px] p-7 bg-white dark:bg-white/[0.04]
                  border border-gray-100 dark:border-white/[0.07] shadow-[0_2px_20px_rgba(0,0,0,0.05)]">
            ...
            <div className="lg:sticky lg:top-8">
              ...
              {course.tags.length > 0 && (
                <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
                  className="mt-4 rounded-[20px] p-5 bg-white dark:bg-white/[0.04]
