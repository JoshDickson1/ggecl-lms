    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center gap-2 pl-2 pr-2.5 py-1.5 rounded-full
          ...
          <div className="relative w-7 h-7 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-indigo-200/50 dark:ring-indigo-500/20">
            {user?.avatarUrl
          ...
          <div className="hidden sm:flex flex-col items-start leading-none">
            ...
            <span className="text-[9px] text-gray-400 mt-0.5">Instructor</span>
          </div>
      ...
      <DropdownMenuContent align="end" className="w-52 rounded-[18px] border border-gray-100 dark:border-white/[0.07] shadow-[0_16px_48px_rgba(0,0,0,0.14)] bg-white dark:bg-[#0f1623] p-1.5">
        <DropdownMenuLabel className="px-2.5 py-2 rounded-[14px] bg-gray-50 dark:bg-white/[0.03] mb-1">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-indigo-200/50 dark:ring-indigo-500/20">
              {user?.avatarUrl
                ? <img src={user.avatarUrl} alt="" className="w-full h-full object-cover" />
                : <div className="w-full h-full bg-gradient-to-br from-indigo-500 to-blue-500 flex items-center justify-center">
            ...
            <div className="min-w-0">
              ...
              <span className="text-[9px] font-bold px-1.5 py-0.5 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 inline-block mt-0.5">Instructor</span>
            </div>
          </div>
        </DropdownMenuLabel>
        <DropdownMenuItem asChild>
          <Link to="/instructor" className="flex items-center gap-2.5 px-2.5 py-2.5 rounded-[14px] cursor-pointer text-[12.5px]">
        ...
        <DropdownMenuItem asChild>
          <Link to="/instructor/profile" className="flex items-center gap-2.5 px-2.5 py-2.5 rounded-[14px] cursor-pointer text-[12.5px]">
        ...
        <DropdownMenuItem asChild>
          <Link to="/instructor/settings" className="flex items-center gap-2.5 px-2.5 py-2.5 rounded-[14px] cursor-pointer text-[12.5px]">
        ...
        <DropdownMenuItem onClick={() => { logout(); navigate("/instructor/login"); }}
