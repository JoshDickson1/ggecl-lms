...
function CourseCardGrid({ course, index }: { course: Course; index: number }) {
  ...
  return (
    ...
    >
      {/* Thumbnail */}
      <Link to={`/student/courses/${course.id}`} className="block flex-shrink-0">
...
// ─── Main Page ────────────────────────────────────────────────────────────────
export default function StudentSingleCategory() {
  const { id } = useParams();
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] dark:bg-[#080c17]">
      ...
      {/* ── Hero ──────────────────────────────────────────────────────────── */}
      <div className="relative overflow-hidden pt-2 rounded-2xl bg-white dark:bg-[#0a0c1c]">
