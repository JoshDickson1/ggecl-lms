        ...
        setTimeout(() => {
          if (i < STEPS.length - 1) {
            ...
            setTimeout(() => {
              if (success) {
                clearCart();
                navigate("/student/cart/order-complete?status=success");
              } else {
                navigate("/student/cart/order-complete?status=failed");
              }
            }, 900);
          }
        }, total)
      ...
      >
        <div className="rounded-[28px] p-10 text-center
          ...
          <h2 className="text-xl font-black text-gray-900 dark:text-white mb-2">
            {done ? "Payment Confirmed!Student" : "Processing Payment"}
          </h2>
